...
<body>
	...
	<div class="outer" >
		<div class="terms-area">
			<div class="">
				<input type="checkbox" name="" id="">네이버 이용약관, 개인정보 수집 및 이용, 위치정보 이용약관(선택), <br>모두 동의합니다.
			</div>
			<input type="checkbox" id="terms1">시네마헤븐 이용약관 동의(필수)
			<div class="terms">
				<p>
					여러분을 환영합니다.
			...
			<input type="checkbox" name="" id="">위치정보 이용약관 동의(선택)
			<div class="terms">
				<p>
